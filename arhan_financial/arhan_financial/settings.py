"""
Django settings for arhan_financial project.
...
# Ensure this matches your models.py class name exactly (User vs user)
...
ROOT_URLCONF = 'arhan_financial.urls'
...
WSGI_APPLICATION = 'arhan_financial.wsgi.application'
...
CELERY_TASK_DEFAULT_QUEUE = 'Identity_service.internal'
