...
SECRET_KEY = 'django-insecure-dv7n6*nlmjry%#o%z(gz@twozu49yv#0o$^jsa%ps4n-fzf2zm'
...
SIMPLE_JWT = {
    ...
    'TOKEN_CLAIMS_SERIALIZER': 'Identity_service.serializers.combine_custom_claims',
}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        #'Identity_service.utils.UUIDSafeJWTAuthentication',
