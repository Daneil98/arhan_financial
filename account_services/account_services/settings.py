"""
Django settings for account_services project.
...
# Updated to use Pathlib for consistency
...
ROOT_URLCONF = 'account_services.urls'
...
WSGI_APPLICATION = 'account_services.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default='sqlite:///' + os.path.join(BASE_DIR, 'account_service.sqlite3'),
        conn_max_age=600
    )
}
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'account_service.sqlite3'),
    }
}
...
CELERY_TASK_DEFAULT_QUEUE = 'account_service.internal'
