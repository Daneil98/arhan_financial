...
SECRET_KEY = 'django-insecure-^%wz!cfi16s2k4cmw@wkrs5+lqk=ziz1nglzxw+uc@-2inek6)'
...
SIMPLE_JWT = {
    ...
    'TOKEN_USER_CLASS': 'payments.models.User', 
    'TOKEN_CLAIMS_SERIALIZER': 'payments.serializers.combine_custom_claims',
}
