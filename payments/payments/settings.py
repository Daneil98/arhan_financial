...
SIMPLE_JWT = {
    ...
    # Ensure this model exists if using DB auth, or switch to Stateless pattern
    'TOKEN_USER_CLASS': 'payment.models.User', 
    'TOKEN_CLAIMS_SERIALIZER': 'payment.serializers.combine_custom_claims',
}
...
INSTALLED_APPS = [
    ...
    # Local Apps
    'payment', # Note: Your app name is 'payment' (Singular)
...
CELERY_TASK_DEFAULT_QUEUE = 'payment.internal'
